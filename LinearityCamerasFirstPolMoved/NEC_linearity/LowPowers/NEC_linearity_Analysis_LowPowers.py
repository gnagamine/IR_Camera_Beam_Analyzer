...
if __name__ == '__main__':
    ...
    NEC_dir_path_highpowers = ('/Users/Shared/Files From c.localized/Gabriel_UniBern_Local/DataAnalysis/Low cost THz Camera/20250523/NEC/LowPowerRange/AllMeasurements')
    measured_voltage_converted_from_lock_in_to_osciloscope_V = .017*3.08
    ...
    title = 'NEC Low Power with calibration'
