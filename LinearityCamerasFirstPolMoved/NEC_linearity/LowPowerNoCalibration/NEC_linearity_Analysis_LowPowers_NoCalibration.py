...
if __name__ == '__main__':
    ...
    NEC_dir_path_highpowers = ('/Users/Shared/Files From c.localized/Gabriel_UniBern_Local/DataAnalysis/Low cost THz Camera/20250523/NEC/LowPower_all_same_calibration_done28May')
    measured_voltage_converted_from_lock_in_to_osciloscope_V = .014*3.08
    ...
    title = 'NEC Low Power with NO calibration'
